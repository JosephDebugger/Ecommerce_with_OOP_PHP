            ...
            <div class="row justify-content-center">
                <div class="col-6">
                    ...
                    <form action="update.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 row">
                            <label for="inputTitle" class="col-sm-2 col-form-label">Full Name:</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputTitle" name="full_name"
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputTitle" name="user_name"
                        ...
                        <div class="mb-3 row">
                            <label for="inputTitle" class="col-sm-2 col-form-label">Mobile:</label>
                            <div class="col-sm-10">
